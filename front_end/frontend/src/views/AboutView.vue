<template>
  <div>
    <h1 align="left">Registro de Paciente:</h1>
  </div>
  <form    
    v-on:submit.prevent="registrarPaciente"
    style="width: 1000px; margin:left;"
    class="row g-3 needs-validation"
  >
  <div align="left" style="margin-bottom: 20px">
    <div class="col-md-12">
      <label for="validationCustomCC" class="form-label">Cédula</label>
      <input
        type="number"
        class="form-control"
    ...
    <div class="col-md-6">
      <label for="validationCustom08" class="form-label">Latitud</label>
      <input
        type="number"
        class="form-control"
        id="validationCustom08"
        v-model="paciente.latitud"
        required
      />
      <div class="valid-feedback"> - </div>
    </div>
    <div class="col-md-6">
      <label for="validationCustom09" class="form-label">Longitud</label>
      <input
        type="number"
        class="form-control"
        id="validationCustom09"
        v-model="paciente.longitud"
        required
      />
    </div>
...
<style>
 body {
  background-color: rgba(109, 237, 244, 0.183);
